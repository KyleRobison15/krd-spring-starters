 ...
 * <p>
 * Validates passwords against the configured policy defined in {@link PasswordPolicy}.
 * Uses Spring dependency injection to access the password policy configuration.
 * <p>
 * Provides specific, user-friendly error messages for each validation failure.
 */
@AllArgsConstructor
